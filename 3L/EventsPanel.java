    ...
    implements Animated, MouseListener, MouseMotionListener
{
    ...
    public EventsPanel( Container parent ) 
    {
        ...
        bball2.setLocation( 150, 150 );
        bball2.setSize( 20, 20 );
        bball2.setMove( 7, 11 );
        _movers.add( bball2 );
        _ashapes.add( bball2 );
        ...
        JMovableEllipse bball3 = new JMovableEllipse( Color.BLACK );
        bball3.setLocation( 15, 15 );
        ...
        JMovableEllipse bball4 = new JMovableEllipse( Color.GREEN );
        bball4.setLocation( 200, 200 );
        bball4.setSize( 30, 30 );
        bball4.setMove( 15, 11 );
        _movers.add( bball4 );
        this.add( bball4 );
        ...
        //         and give it different setMove parameters
        ////////////////////////////////////////////////////////////////
        JPlayer jp = new JPlayer( Color.CYAN, 300, 300 ); 
        jp.setMove( 15, 11 );
        _movers.add( jp );
        this.add( jp );
        ...
        ////////////////////////////////////////////////////////////////
        JPlayer jp2 = new JPlayer( Color.GRAY, 150, 150 );
        jp.setMove( 16, 17 );
        this.add( jp2 );
