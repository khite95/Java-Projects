...
public class RadioSliderGUI extends JPanel
{
    ...
    private void buildSliders( Container parent )
    {
        ...
        JSlider sSlider;   // slider controls height and width
        //------------- X Slider  ------------------------------------
        ...
        //////////////////////////////////////////////////////////////
        sSlider = new JSlider( JSlider.VERTICAL, 0, 200, _initSize );
        addLabels( sSlider, 100 );
        sSlider.setBorder( new LineBorder( Color.BLACK, 2 ) );
        sSlider.setInverted( true );
            
        SliderListener sListen = new SliderListener( sSlider, "size" );
        sSlider.addChangeListener( sListen );
