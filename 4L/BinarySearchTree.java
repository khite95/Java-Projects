...
public class BinarySearchTree 
{
    ...
    private String inOrderString( Node n )
    {
        ...
        if( n.left != null )
        {
            return inOrderString( n.left ) + " " + n.left.data + " ";
            //return left + " ";
        }
        if( n.right != null )
        {
            return inOrderString( n.right ) + " " + n.right.data  + " ";
            //return right + " ";
        }
        return "";*/
        if( n.left != null ) 
    ...
    private Data maxFind( Node n )
    {
        ...
        if( n.right != null )
        {
            right = maxFind( n.right );
        }
        

        
        if( right.value >= left.value && right.value >= node.value  )
        {
            return right;
        }
        else if( left.value >= right.value && left.value >= node.value )
        {
            return left;
        }
        else
